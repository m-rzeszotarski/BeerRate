...
urlpatterns = [
    ...
    path('order/<int:pk>/pending', views.order_pending, name='order_pending'),
    path('order/<int:pk>/shipped', views.order_shipped, name='order_shipped'),
    path('order/<int:pk>/cancelled', views.order_cancelled, name='order_cancelled'),
